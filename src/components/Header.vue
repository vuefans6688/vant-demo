...
<template>
  <div class="header">
    <div class="header-content">
      ...
      <div class="other">
        <span class="blank" v-if="!((rightBtn.imgSrc && rightBtn.imgSrc.length)
          || (rightBtn.iconName && rightBtn.iconName.length) || rightBtn.textValue)">
        </span>
        <img
        ...
        <p v-if="rightBtn.textValue" @click="handleText()">{{ rightBtn.textValue }}</p>
      </div>
    </div>
  </div>
</template>
